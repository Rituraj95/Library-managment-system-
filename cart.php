						...
						<div style="text-align:center;text-decoration:underline"><h3>Your Cart</h3></div>
							<div class="cart_container">
								...
								<div class="cart_total">
									<h4> Book ID. <span class="cart_value"><?php echo $total; ?></span></h4>
									<a href="purchase.php?total=<?php global $total;echo $total ?>"><input type="submit" id="btn-logic" class="btn btn-success" value="Issue"></a>
								</div>
								<?php endif; ?>
							</div>
						</div>
